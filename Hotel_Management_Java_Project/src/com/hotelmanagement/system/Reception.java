...
public class Reception extends JFrame implements ActionListener {
	JButton newCustomer,searchRoom,logout, rooms,update,roomUpdate,pickup, department,allEmployee,checkout,customer,manager ;
	...
	public  Reception() {
		...
		add(logout);
		 ...
		 ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/r.jpg"));
       
         JLabel image = new JLabel(i1);
         image.setBounds(250,5,520,520);
